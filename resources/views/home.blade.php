...
@section('title')
 لوحة التحكم - مورا سوفت للادارة القانونية
@endsection
@section('css')
<!--  Owl-carousel css-->
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  ...
						  <p class="mg-b-0">برنامج ادارة الفواتير الرقمية</p>
						</div>
					</div>
					<div class="main-dashboard-header-right">
						<div>
							<label class="tx-13">تقييم المستخدمين</label>
							<div class="main-star">
								<i class="typcn typcn-star active"></i> <i class="typcn typcn-star active"></i> <i class="typcn typcn-star active"></i> <i class="typcn typcn-star active"></i> <i class="typcn typcn-star"></i> <span>({{number_format(\App\Models\User::count())}})</span>
							</div>
						</div>
						<div>
							<label class="tx-13">اجمالي الفواتير</label>
...
@endsection
@section('content')
				{{-- start invoices detailes --}}
				<div class="row row-sm">
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-primary-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h3 class="mb-3 tx-12 text-white">اجمالي الفواتير</h3>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-danger-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h3 class="mb-3 tx-12 text-white">الفواتير الغير مدفوعة</h3>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
											<h4 class="tx-20 font-weight-bold mb-1 text-white">${{number_format(\App\Models\invoices::where('Value_Status','=','2')->sum('Total'),2)}}</h4>
											<p class="mb-0 tx-12 text-white op-7">عدد الفواتير الغير مدفوعة {{\App\Models\invoices::where('Value_Status','=','2')->count()}}</p>
										</div>
										<span class="float-right my-auto mr-auto">
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-success-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h3 class="mb-3 tx-12 text-white">الفواتير المدفوعة</h3>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
					...
					<div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
						<div class="card overflow-hidden sales-card bg-warning-gradient">
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								<div class="">
									<h3 class="mb-3 tx-12 text-white">الفواتير المدفوعة جزئيا</h3>
								</div>
								<div class="pb-0 mt-0">
									<div class="d-flex">
										<div class="">
				...
				{{-- end invoices detailes --}}

				{{-- start charts detailes --}}
				<div class="row row-sm">
