...
@section('title')
الاقسام - مورا سوفت للادارة القانونية
@endsection
    ...
    <div class="alert alert-danger alert-dismissable fade show" role="alert">
      <ul>
        @foreach ($errors->all() as $error)
            <li>{{$error}} <button type="button" class="close" data-dismiss="alert" aria-label="close"><span aria-hidden="true">&times;</span></button></li>
        @endforeach
      </ul>
    </div>
@endif
          ...
          <div class="card mg-b-20">
              <div class="card-header pb-0">
                  <div class="d-flex justify-content-between">
                    @can('اضافة قسم')
                        <a class="modal-effect btn btn-primary btn-block" data-effect="effect-scale" data-toggle="modal" href="#modaldemo8" style="width: fit-content"><i class="fa fa-plus"></i> اضافة قسم</a>
                    @endcan
                  </div>
              </div>
              <div class="card-body">
