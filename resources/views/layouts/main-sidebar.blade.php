			...
			<div class="main-sidemenu">
				<div class="app-sidebar__user clearfix">
					<div class="dropdown user-pro-body">
						<div class="">
							<img alt="user-img" class="avatar avatar-xl brround" src="{{URL::asset('assets/img/user_icon.jpg')}}"><span class="avatar-status profile-status bg-green"></span>
						</div>
					@auth
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								...
								@can('الفواتير المدفوعة')
									<li><a class="slide-item" href="{{ url('Invoice_Paid') }}">الفواتير المدفوعة</a></li>
								@endcan
								@can('الفواتير المدفوعة جزئيا')
									<li><a class="slide-item" href="{{ url('Invoice_Partial')}}">الفواتير المدفوعة جزئيا</a></li>
								@endcan
					...
					@can('التقارير')
						<li class="slide">
							...
							<ul class="slide-menu">
								...
								@endcan
								@can('تقرير العملاء')
									<li><a class="slide-item" href="{{ url('/' . $page='users_report') }}">تقارير العملاء</a></li>
								@endcan
							</ul>
						</li>
					@endcan
