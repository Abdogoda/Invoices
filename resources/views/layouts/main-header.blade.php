					...
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
									...
									<div class="dropdown-menu">
										<div class="menu-header-content bg-primary text-right">
											<div class="d-flex">
												...
												<a href="/mark_all_read" class="badge badge-pill badge-warning mr-auto my-auto float-left">تعيين الكل كمقروء</a>
											</div>
											<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 " id="notifications_count">لديك {{ auth()->user()->unreadNotifications->count() }} اشعارات غير مقروئة</p>
										</div>
										<div class="main-notification-list Notification-scroll" id="unread_notifications">
											@foreach(auth()->user()->unreadNotifications as $notification)
											<a class="d-flex p-3 border-bottom" href="/invoiceDetails/{{$notification->data['id']}}">
												<div class="notifyimg bg-primary">
													<i class="la la-check-circle text-white"></i>
												</div>
												<div class="mr-3">
													<h5 class="notification-label mb-1">{{$notification->data['title']}} بواسطه {{$notification->data['user']}}</h5>
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset('assets/img/user_icon.jpg')}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{URL::asset('assets/img/user_icon.jpg')}}" class=""></div>
											@auth
									...
									<a class="dropdown-item" href=""><i class="bx bx-user-circle"></i>الحساب </a>
									<a class="dropdown-item" href=""><i class="bx bx-cog"></i> تعديل الحساب</a>
